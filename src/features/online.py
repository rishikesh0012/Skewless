...
from features.faults import SkewMode, apply_fault
...
def transform_trip(trip: TaxiTrip, skew_mode: SkewMode = SkewMode.NONE) -> FeatureVector:
    """Independent serving transformation used to demonstrate duplicated logic."""
    ...
    return apply_fault(features=features, trip=trip, mode=skew_mode)
